...
<div class="eventmesh-sync-status">
    ...
    <p>
        ...
        <?php echo esc_html(\EventMesh\Support\SyncStatus::label((string) ($syncState['status'] ?? 'idle'))); ?>
    </p>
    <p>
    ...
    <?php if (false !== $nextRun) : ?>
        <p>
            ...
            <?php echo esc_html(\EventMesh\Support\DateTimeFormat::format((int) $nextRun)); ?>
        </p>
    <?php endif; ?>
</div>
